...
#define EDITOR_UPDATE_RENDER(name) \
	name(float dt, s_program_memory *program_memory, editor_input *editor_input, game_renderer *game_renderer)
typedef EDITOR_UPDATE_RENDER(editor_update_render);
EDITOR_UPDATE_RENDER(editor_update_render_undefined)
{
	return(0);
}
